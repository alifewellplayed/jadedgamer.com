    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "approval_status",
                    models.SmallIntegerField(choices=[(1, "Pending"), (2, "Denied"), (3, "Approved")], default=1),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "feed",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="aggregator.Feed"
                    ),
                ),
                (
                    "tags",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "can_self_add",
                    models.BooleanField(
                        choices=[(True, "Only me"), (False, "Everyone")],
                        default=True,
                        help_text="Who can edit this list?",
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="feed_lists",
                to="aggregator.FeedList",
            ),
        ),
        migrations.AddField(
            model_name="feed",
