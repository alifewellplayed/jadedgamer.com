...
from coreExtend import settings as r_settings

#from redirection.urls import pulse as REDIRECTION_URLS
...
urlpatterns = [
    ...
    url(r'^api/v2/', include('api.urls', namespace='rest_api')),
    ...
    # Apps
    #url(r'^r/', include(REDIRECTION_URLS, namespace='JadedRedirection')),
